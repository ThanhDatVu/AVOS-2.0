            ...
            function d(t, n) {
                try {
                    if ((t.focus(), i.default.isEdge() || i.default.isIE()))
                        try {
                            t.contentWindow.document.execCommand(
                                "print",
                                !1,
                                null
                            );
            ...
            (t.addWrapper = function (e, t) {
                ...
                (t.loopNodesCollectStyles = function e(t, n) {
                    for (var r = 0; r < t.length; r++) {
                        ...
                        if (
                            -1 ===
                            n.ignoreElements.indexOf(o.getAttribute("id"))
                        ) {
                            var i = o.tagName;
                            if (
                                "INPUT" === i ||
        ...
        function (e, t, n) {
            ...
            t.default = {
                init: function () {
                    ...
                    if (void 0 === e)
                        throw new Error(
                            "printJS expects at least 1 attribute."
                        );
            ...
            t.default = {
                print: function (t, e) {
                    if ("object" !== o(t.printable))
                        throw new Error(
                            "Invalid javascript data object (JSON)."
                        );
                    ...
                    if (!t.properties || !Array.isArray(t.properties))
                        throw new Error(
                            "Invalid properties array for your JSON data."
                        );
