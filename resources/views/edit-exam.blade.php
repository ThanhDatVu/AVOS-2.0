                    ...
                    <form action=""  id="editor" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="titre" type="text" id="" class="form-control" placeholder="{{ $exam->title}}" aria-describedby="helpId" >
                            </div>

                            <div class="form-group">
                                <label for="">Mô tả</label>
                                <input name="descriptif" type="text" id="" class="form-control" placeholder="{{ $exam->descriptif}}" aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                <label for="">Số câu hỏi</label>
                                <input name="number_of_questions" type="text" id="" class="form-control" placeholder="{{ $exam->objectif}}" aria-describedby="helpId">
                            </div>
