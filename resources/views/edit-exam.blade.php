                    ...
                    <form action="" id="editor" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="titre" type="text" id="" class="form-control" value="{{ $exam->title}}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="descriptif" type="text" id="" class="form-control"
                                       value="{{ $exam->description}}" aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                <label for="">Số câu hỏi</label>
                                <input name="number_of_questions" type="text" id="" class="form-control"
                                       value="{{ $exam->number_of_questions}}" aria-describedby="helpId">
                            </div>
