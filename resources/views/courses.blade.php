                                ...
                                <div class="col-lg-8 course-details-left">
                                    ...
                                    <div class="content-wrapper">
                                        ...
                                        <div class="content">
                                            ...
                                            technical terms to learn before you can converse with the experts. This is
                                            certainly
                                            true in astronomy both in
                                            terms of terms that refer to the cosmos and terms that describe the tools of
                                            the trade,
                                            the most prevalent
                                            being the telescope.
                                            <br>
                                        ...
                                        <div class="content">
                                            <ul class="course-list">
                                                <li class="justify-content-between d-flex">
                                                    ...
                                                    <a class="btn text-uppercase" href="{{route('my-course-detail')}}">View
                                                        Details</a>
                                                </li>
                                                <li class="justify-content-between d-flex">
                                                    <p>Basics of HTML</p>
