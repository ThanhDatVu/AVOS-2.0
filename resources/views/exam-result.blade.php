                        ...
                        <div class="col-lg-12 posts-list">
                            <div class="single-post row">
                                ...
                                <div class="container border-l col-lg-10 col-md-10">
                                    ...
                                    <h3 class="mt-20 mb-20 text-green-700">Kết quả: {{$mark}}
                                        / {{$exam->number_of_questions}}</h3>
                                    ...
                                    <div class=" justify-left ml-10">
                                        ...
                                        @foreach($exam->questions as $question)
                                            ...
                                            <h4 class="mb-6 pt-6 mx-auto text-left">Câu {{($loop->index)+1}}
                                            ...
                                            <div class="ml-20 max-w-screen-xl text-left ">
                                                ...
                                                <div class="flex items-center mr-4 mb-4">
                                                    <label for="radio0{{$loop->index}}"
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;@if($question->correctAnswer=="A")
                                                            <mark class="bg-green-300 ">Đáp án đúng @endif </mark>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="flex items-center mr-4 mb-4">
                                                    ...
                                                    <label for="radio1{{$loop->index}}" class="flex items-center ">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;@if($question->correctAnswer=="B")
                                                            <mark class="bg-green-300 ">Đáp án đúng @endif</label>
                                                </div>
                                                ...
                                                <div class="border rounded  ">
                                                    <h5 class="mt-20 mb-20"> &nbsp; Bạn chọn đáp án
                                                        : {{$answer[$loop->index]}}
                                                    ...
                                                    @if(!is_null($question->explanation))
                                                        <p class="ml-4 mb-20"><strong>Giải
                                                                thích: </strong> {{$question->explanation}}</p>
                                                    @endif
