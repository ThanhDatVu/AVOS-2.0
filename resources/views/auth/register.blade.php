                ...
                <div class="flex flex-col items-center w-full px-4 py-5 bg-white md:w-1/2 md:py-8">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
                        ...
                        <input type="file" accept="image/jpeg, image/png" name="avatar"
                               ...
                               id="avatarImg">
                        <label for="avatarImg"
                               class="w-full px-4 py-2 text-base placeholder-gray-500 placeholder-opacity-50 transition-all duration-200 ease-in-out bg-green-100 border-green-700 rounded shadow-sm hover:text-gray-100 hover:bg-green-600 tborder focus:outline-none focus:border-green-500 ">Choose
                            a picture image for profile</label>
                        <input
                        ...
                        <select name="country"
                                ...
                                id="country">
                            <option class="w-full px-4" value="">&nbsp;&nbsp;&nbsp;Country&nbsp;&nbsp;&nbsp;&nbsp;
                            </option>
                        ...
                        <select name="gender"
                                class="pl-10 text-base placeholder-gray-500 placeholder-opacity-50 border border-gray-300 rounded shadow-sm col-12 fil focus:outline-none focus:border-green-500"
                                id="gender">
                            <option class="w-full px-4" value="">&nbsp;&nbsp;&nbsp;Gender&nbsp;&nbsp;&nbsp;&nbsp;
                            </option>
