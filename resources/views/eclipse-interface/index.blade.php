                    ...
                    <div class="owl-carousel video-carousel">
                        <div class="single-video">
                            <div class="video-part">
                                <img class="img-fluid"
                                     src="{{isset(Auth::user()->avatar)?Storage::url(Auth::user()->avatar):Storage::url("courses/default0.png")}}"
                                     alt="">
            ...
            <div class="row align-items-end">
                ...
                <div class="offset-lg-3 col-lg-4 col-md-6">
                    <div class="course-form-section">
                        ...
                        <form class="text-right course-form-area contact-page-form course-form" id="myForm"
                              action="mail.html"
                              method="post">
