...
@extends("eclipse-interface.layouts.eclipse",["title"=>"Course"])
@section("banner")
    <!-- ================ start banner Area ================= -->
        ...
        <div class="container-fluid">
            ...
            <div class="owl-carousel popuar-course-carusel">
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="mx-auto f-img img-fluid" src="img/popular-course/p1.jpg" alt=""/>
                    </div>
                    <div class="details">
                ...
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="mx-auto f-img img-fluid" src="img/popular-course/p2.jpg" alt=""/>
                    </div>
                    <div class="details">
                        <div class="mb-20 d-flex justify-content-between">
                            <p class="name">programming language</p>
                ...
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="mx-auto f-img img-fluid" src="img/popular-course/p3.jpg" alt=""/>
                    </div>
                    <div class="details">
                        <div class="mb-20 d-flex justify-content-between">
                            <p class="name">programming language</p>
                ...
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="mx-auto f-img img-fluid" src="img/popular-course/p4.jpg" alt=""/>
                    </div>
                    <div class="details">
                        <div class="mb-20 d-flex justify-content-between">
                            <p class="name">programming language</p>
